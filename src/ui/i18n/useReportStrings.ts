...
export function useReportStrings(): ReportStrings {
  ...
  return useMemo<ReportStrings>(() => {
    ...
    return {
      ...
      txRequestHeadersLabel: t('reportContent.txRequestHeadersLabel'),
      txRequestBodyLabel: t('reportContent.txRequestBodyLabel'),
      txResponseLabel: t('reportContent.txResponseLabel'),
      txResponseHeadersLabel: t('reportContent.txResponseHeadersLabel'),
      txResponseBodyLabel: t('reportContent.txResponseBodyLabel'),
      txBinaryLabel: t('reportContent.txBinaryLabel'),
      credentialsHeading: t('reportContent.credentialsHeading'),
      credBasicLabel: t('reportContent.credBasicLabel'),
      credBearerLabel: t('reportContent.credBearerLabel'),
      credUsernameFieldLabel: t('reportContent.credUsernameFieldLabel'),
      credPasswordFieldLabel: t('reportContent.credPasswordFieldLabel'),
      credBodyFormatLabel: t('reportContent.credBodyFormatLabel'),
      ...
      jwtSignature: t('reportContent.jwtSignature'),
